      ...
      .on(
        ...
        (payload) => {
          if (payload.eventType === "INSERT") {
            ...
            const href = getNotificationHref(inserted);
            ...
            toast.custom(
              (t) => (
                <button
                  ...
                  onClick={() => {
                    if (href) {
                      void handleMarkOneAsRead(inserted.id);
                      router.push(href);
                    }

                    toast.dismiss(t.id);
                  }}
                  className={`w-[320px] rounded-2xl border border-stone-200 bg-white p-4 text-left shadow-xl transition-all ${
                    t.visible
              ...
              {
                duration: 4000,
                id: `admin-notification-${inserted.id}`,
              }
            );
